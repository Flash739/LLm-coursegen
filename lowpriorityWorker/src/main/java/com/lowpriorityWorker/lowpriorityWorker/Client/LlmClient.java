package com.lowpriorityWorker.lowpriorityWorker.Client;
    ...
    public String generateSubsectionContent(String topic, String sectionTitle, String subsectionTitle) {
        String prompt = String.format(
                "You are an expert instructor creating detailed educational content. " +
                        "Write a comprehensive, beginner-friendly, and fully self-contained explanation for the subsection titled '%s' " +
                        "from the section '%s' in a course on '%s'.\n\n" +
                        "Make sure:\n" +
                        "1. The explanation covers all foundational concepts, definitions, and examples.\n" +
                        "2. Include step-by-step breakdowns, where applicable.\n" +
                        "3. Add analogies or visualizations to aid understanding.\n" +
                        "4. Avoid jargon unless explained clearly.\n" +
                        "5. Assume the reader has no prior knowledge and should not need to refer to any external resource.\n" +
                        "6. Conclude with a short summary to reinforce key ideas.\n\n" +
                        "Start writing the subsection content now.",
